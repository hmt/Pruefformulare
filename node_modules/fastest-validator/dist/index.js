(function (global, factory) {
	...
	Validator.prototype.compileSchemaObject = function(schemaObject) {
		...
		var strict = schemaObject.$$strict;
	...
	Validator.prototype.compileMessages = function(schemaType) {
		...
		if (schemaType.messages) {
			return this.messageKeys.reduce(function (a, key) {
				a[key] = schemaType.messages[key] || this$1.messages[key];
				return a;
			}, {});
		}
	...
	Validator.prototype.compileSchemaRule = function(schemaRule) {
		...
		var messages$$1 = this.compileMessages(schemaRule);
	 ...
	 */
	Validator.prototype.handleResult = function(errors, fieldPath, res, messages$$1) {
		var this$1 = this;
		...
		items.forEach(function (err) {
			if (!err.field)
				{ err.field = fieldPath; }
			if (!err.message)
				{ err.message = this$1.resolveMessage(err, messages$$1[err.type]); }
