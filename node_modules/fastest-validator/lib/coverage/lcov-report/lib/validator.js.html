...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\index.html">All files</a> / <a href="index.html">lib</a> validator.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
			...
			if (check.name) {
				...
				value = obj;
				stack = pathStack ? pathStack : <span class="branch-1 cbranch-no" title="branch not covered" >"";</span>
			}
&nbsp;
...
Validator.prototype.resolveMessage = function(err) {
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if (msg != null) {
